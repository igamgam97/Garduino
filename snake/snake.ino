...
bool bup_button = false;
bool bdown_button = false; 
bool bleft_button = false;
bool bright_button = true;
...
void moveSnake(void){
    for (int i = 0; i < lengthShake; i++){
        switch (queue[i]){
            case 1:
                {
                    if(_BlockSnacke[i].Y - 3 < 3){
                        _BlockSnacke[i].Y = 126;
                    }
...
void speedShake(void){
    if (lengthShake < 11) 
        speedSnake = 100;
    else if (lengthShake < 21)
        speedSnake = 50;
    else if (lengthShake < 36) 
        speedSnake = 25;
    else 
        speedSnake = 10;
}
